...
template sudoku() {
    ...
    component puzzleRange[9][9]; // to check 81 values individually I created 2d array of 9 components
    component solutionRange[9][9]; // beacause same variable cannot be reassigned
